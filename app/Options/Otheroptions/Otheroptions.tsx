      ...
      <div className={styles.container}>
        ...
        <div className={styles.section}>
          <div className={styles.txt}>
            <h2>language</h2>
            <p>
              Manage the language of your Google Search display and choose the
              settings you want for your results
            </p>
            <Otherbtn
          ...
          <div className={styles.txt}>
            ...
            />
            <Otherbtn
              name="Open results in a new window"
              src="add.png"
              img="switches.png"
            />
            <Otherbtn
              name="Autocomplete with trending searches"
              src="pencil.png"
              img="switches.png"
            />
          </div>
